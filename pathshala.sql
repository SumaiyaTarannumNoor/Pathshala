...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2024 at 11:52 AM
...
(1, 'Freelancing Patashala', '\"Freelancing Patashala” is a television training program on digital course which is going to be aired on Nexus Television from 1st January 2024 in collaboration with the Directorate of ICT to achieve the goal of Digital Bangladesh and to improve the skills of the youth society through freelancing. The program will be telecast on Nexus Television as live. The program will cover various topics which have importance to freelancing platform', 'logo_aa.jpg', 'Home', 'Education & Work', 'Services & Products', 'Partners & Gallery', 'Contact', '2024-01-09 11:10:04');
...
INSERT INTO `trainees` (`trainee_id`, `full_name`, `email`, `phone_number`, `address`, `skills`, `educational_level`, `institution`, `educational_certificates`, `freelancing_experience`, `portfolio_link`, `availability`, `preferred_work_type`, `hourly_rate`, `language_proficiency`, `certifications`, `linkedIn_profile`, `github_profile`, `course_joining_date`) VALUES
(4, 'ede', 's2@gmail.com', 'wedw', 'dsd', NULL, 'dsda', 'asd', 'sdasd', NULL, NULL, 'sd', NULL, NULL, NULL, NULL, NULL, NULL, '2024-02-07'),
(6, 'ede', 's6@gmail.com', 'wedw', 'dsd', NULL, 'dsda', 'asd', 'sdasd', NULL, NULL, 'sd', NULL, NULL, NULL, NULL, NULL, NULL, '2024-02-07'),
(7, 'Shelly', 'shelly@gmail.com', '402834', 'ty road', NULL, 'HSc', 'Lalmatia mohila college', 'SSc, HSc', 'none', 'none', 'none', 'none', 0.00, 'none', 'none', 'none', 'none', '2024-02-28'),
(8, 'Kashif', 'kashif@gmail.com', '9078564', 'Dhanmondi, Dhaka', NULL, 'BSc', 'South East University', 'BSc', '', '', 'Not Available', '', 0.00, '', '', '', '', '2024-03-06');
